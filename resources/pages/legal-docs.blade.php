    ...
    <div class="uk-section">
        <div class="uk-container">
            <div class="uk-grid">
                ...
                <div class="uk-grid-divider uk-child-width-1-3@m uk-child-width-1-2@s uk-grid" data-uk-grid="">
                    <div class="uk-first-column">
                        <i class="fas fa-file fa-lg in-icon-wrap primary-color"></i>
                        <h3 class="uk-margin-top">Terms of Service</h3>
                        <p>Read the Terms of Service and License Agreement for Algotrade as well as our Portal Usage &amp; Agreements.</p>
                    ...
                    <div>
                        ...
                        <p>Find out more about what information we collect at Algotrade, how we use it, and what control you have over your data.</p>
                        <ul class="uk-list uk-margin-top">
                            <li><a class="uk-flex uk-flex-middle" href="#"><i class="fas fa-file-pdf fa-sm uk-margin-small-right"></i>Privacy Statement</a></li>
                        </ul>
                    </div>
                    <div class="uk-visible@m">
                        <i class="fas fa-shield-alt fa-lg in-icon-wrap primary-color"></i>
                        ...
                        <ul class="uk-list uk-margin-top">
                            <li><a class="uk-flex uk-flex-middle" href="#"><i class="fas fa-file-pdf fa-sm uk-margin-small-right"></i>Trade Security</a></li>
                ...
                <div class="uk-width-3-5@m">
                    <div class="uk-card uk-card-large uk-card-default in-card-paper">
                        <div class="uk-card-body">
                            ...
                            <p>The information and materials contained in these pages, and the terms, conditions, and descriptions that appear, are subject to change. Unauthorized use of Algotrade'
                                web sites and systems including but not limited to unauthorized entry into Algotrade' systems, misuse of passwords, or misuse of any information posted on a site is strictly
                                prohibited. Not all products and services are available in all geographic areas. Your eligibility for particular products and services is subject to final determination by Algotrade and/or its affiliates. Copyright and Trademark. Copyright in the pages and in the screens displaying the pages, and in the information and material therein and in their arrangement, is owned by Algotrade unless otherwise indicated.
                                Algotrade, LTD and the Algotrade are trademarks and service marks of Algotrade and are used and/or registered throughout the world. Algotrade, Ltd and their subsidiaries also claim rights in certain other trademarks and service marks contained in these web pages.</p>

                            <p><b>CUSTOMER TRADING AGREEMENT</b></p>
                            <p>This Client Trading Agreement("Agreement") is between Algotrade Limited and its affiliates, operator of the brand name Algotrade (hereinafter: "Algotrade")
                            ...
                            <p>1. General Services Rule: Client may enter into transactions with Algotrade, in connection with spot and forward foreign currency contracts,
                                foreign currencies swap transactions, and such other transactions as Algotrade may from time to time make available (the “Services”).</p>
                            ...
                            <p>3. Direct Relationship: Unless otherwise agreed in writing, Algotrade and Client each enter into this Agreement as principal and Algotrade will not accept an
                                undisclosed/unapproved principal acting through Client. With regard to such a principal, Client agrees to provide Algotrade with its identity, personal information,
                                and other information that Algotrade may seek.</p>
                            <p>4. No Recommendation or Solicitation: Algotrade does not recommend, solicit, offer, advise, suggest, concur on the merits of, or otherwise provide any opinion
                                ...
                                with Algotrade should be construed in this manner.</p>
                            <p>5. Errors: Quotations provided by Algotrade, via third parties or otherwise, may be incorrect for any reason. Following a transaction involving such quotation
                                errors, Algotrade in its discretion reserves the right to correct the affected account balance. Any dispute arising from such errors or corrections will be
                            ...
                            <p>6. Market Fluctuations: Client acknowledges that the market for currency is subject to sudden changes due news events and other announcements, acts of war or
                                ...
                                factors beyond Algotrade' control. Algotrade may determine in its sole discretion that an emergency or exceptional market condition exists, in which case it
                            ...
                            <p>8. Trading Indices: The Client hereby acknowledge that he is aware that in the case of Contract for Difference (CFD) trade, Algotrade shall open its trading
                                within 5 minutes of the opening of the relevant market. Algotrade reserves the right not to accept any trade of such instrument during the first 5 minutes of the
                                trading day. Algotrade reserves its right to cancel any trade, in its own discretion, of such instrument made during the first 5 minutes of the trading day.</p>
                            <p>9. Algotrade shall execute the Client’s withdrawal within 96 working hours once all the above conditions are met and upon approval of such by the Algotrade
                                ...
                                destination country or any other 3rd party involved in the transfer of funds. Algotrade shall not be liable for any fund transfer delay caused by such 3rd party.</p>
                            <p>10. Complaints: - Based on an operational agreement with Algotrade Ltd., we are responsible for complaints where End-Users have
                                ...
                                at : support@Algotrade.com. We have put in place formal procedures for handling complaints fairly and promptly, and each such filed inquiry shall be
                            ...
                            </p><hr class="uk-margin-medium-top uk-margin-small-bottom">
                            <ul class="in-faq-5 uk-accordion" data-uk-accordion="collapsible: false">
                                <li class="uk-open">
                                    <a class="uk-accordion-title" href="#">Trading Guidelines</a>
                                ...
                                <li>
                                    ...
                                    <div class="uk-accordion-content" hidden="">
                                        ...
                                        We accept that customer trust is the establishment of our business. That is the reason we are straightforward about how we gather and utilize the data you give us, and we need to feature the decisions you have for getting to and controlling your data. If it's not too much trouble see beneath to figure out how our different business lines utilize your data to give you the best customer experience. As usual, you can get in touch with us at support@Algotrade.com with any inquiries or criticism.
                                        ...
                                        We utilize your own data to help items and administrations that you use or that we offer to you. For instance, in the event that you have accounts with us: <br>
                                ...
                                <li>
                                    ...
                                    <div class="uk-accordion-content" hidden="">
                                        <p>Our Company trademarks include the following list. The absence of any Company trademark, product name, service name, or any other name from this list does not belong to Algotrade Company intellectual property rights.</p>
                            ...
                            <div class="uk-card uk-card-default uk-card-small uk-card-body uk-border-rounded uk-margin-medium-top">
                                <p class="uk-text-small">For general inquiries please contact <a class="uk-text-lowercase uk-link" href="mailto:">legal@Algotrade.com</a></p>
                            </div>
                        </div>
                    </div>
                </div>
