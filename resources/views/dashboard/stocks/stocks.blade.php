            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <p class="text-black fs-16">Here are several Stocks. You can invest daily, weekly or monthly and get higher returns in your investment.</p>
                                ...
                                <table id="example4" class="display dataTable no-footer" style="min-width: 845px" role="grid" aria-describedby="example4_info">
                                    ...
                                    @foreach($stocks as $item)
                                        <tr role="row" class="odd">
                                            ...
                                            <td><a href="{{ route('user.invest', $item->id) }}" class="btn btn-primary btn-sm">Invest</a></td>
                                        </tr>
                                    @endforeach
