...
{{--                                                <td class="d-none d-sm-table-cell"> {{ $item->withdraw_method->acctLabel() }}</td>--}}
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.withdrawal.details', $item->id) }}" class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" data-bs-toggle="tooltip" title="View Deposit" data-bs-original-title="View">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    @if($item->status == 0)
                                                        <a href="{{ route('admin.approve_withdrawal', $item->id) }}" class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" data-bs-toggle="tooltip" title="View Deposit" data-bs-original-title="View">
